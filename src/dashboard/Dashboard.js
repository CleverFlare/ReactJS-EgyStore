...
const DashBoard = () => {
  ...
  const handleTabChange = (event) => {
    setCurrentTab(event.target.getAttribute("data-number"));
  };
  return (
    <div className="dashboard">
      <div className="dashboard__tabs">
        <button className="tab" data-number={0} onClick={handleTabChange}>
          tab 1
        </button>
        <button className="tab" data-number={1} onClick={handleTabChange}>
          tab 2
        </button>
      </div>
      <div className="dashboard__content">
        <div className="dashboard__tab-content">content 1</div>
        <div className="dashboard__tab-content">content 2</div>
      </div>
    </div>
  );
};
